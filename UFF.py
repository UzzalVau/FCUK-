...
try:
    ...
    proxy = requests.get('https://github.com/UzzalVau/FCUK-/blob/main/approve.2.txt.git').text.splitlines()
    v = 3.1
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/UzzalVau/FCUK-/blob/main/approve.2.txt.git').text
    if id in httpCaht:
